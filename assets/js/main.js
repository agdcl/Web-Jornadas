...
const I18N = {
  en: {
    ...
    "about.science1":"This conference dedicates a space to scientific dissemination accessible to all, with the aim of converting the best evidence into clear, useful and responsible knowledge. We translate research results into understandable messages, without losing rigour, so that families, students, professionals and the media can interpret data, distinguish evidence from opinion and make informed decisions.",
    ...
    "abstracts.timeline.title":"Key dates","abstracts.timeline.item1":"Nov 20: submissions deadline","abstracts.timeline.item2":"Nov 30: early-bird ends","abstracts.timeline.item3":"Dec 11: conference starts",
    "venue.title":"Venue","venue.copy":"The conference will be held at Miguel Hernández University of Elche, in the Valona Building. Elche offers a wide range of accommodation and dining options around its historic palm grove.",
